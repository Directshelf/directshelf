...
const features = [
  ...
  },
  {
    ...
    description: "Hyperlocal fulfillment centers with smart order routing, managed by us, branded for you",
    Icon: Database,
    aiFeature: "Data-driven placement optimizes coverage and efficiency"
  },
  {
